...
CREATE TABLE Episode (
    ...
    EpisodeInSeason int  NOT NULL CHECK (EpisodeInSeason > 0),
    LengthMin int  NOT NULL CHECK (LengthMin > 0),
...
CREATE TABLE Series (
    SeriesID int  NOT NULL,
    IsFinished int  NOT NULL CHECK (IsFinished = 1 OR IsFinished = 0),
...
CREATE TABLE Subscription (
    ...
    Name varchar(64)  NOT NULL,
    NumberOfDevices int  NOT NULL CHECK (NumberOfDevices > 0),
...
VALUES (1, 'Dennis', 'Savchenko', CONVERT(DATE, '2000-01-15', 23), 'dennissavchenko@gmail.com', '1#@ghf34@', 8, 1);

INSERT INTO UserAccount (UserID, Name, Surname, DateOfBirth, Email, Password, LanguageID, SubscriptionID)
VALUES (2, 'Rose', 'Smith', CONVERT(DATE, '2005-08-22', 23), 'rosesmith@gmail.com', '#ed$%%2ws', 1, 3);

INSERT INTO UserAccount (UserID, Name, Surname, DateOfBirth, Email, Password, LanguageID, SubscriptionID)
VALUES (3, 'John', 'Doe', CONVERT(DATE, '2010-04-05', 23), 'johndoe@gmail.com', 'P@ssw0rd', 3, 2);

INSERT INTO UserAccount (UserID, Name, Surname, DateOfBirth, Email, Password, LanguageID, SubscriptionID)
VALUES (4, 'Emily', 'Johnson', CONVERT(DATE, '2008-11-18', 23), 'emilyjohnson@gmail.com', 'Qwerty123', 5, 1);

INSERT INTO UserAccount (UserID, Name, Surname, DateOfBirth, Email, Password, LanguageID, SubscriptionID)
VALUES (5, 'Michael', 'Brown', CONVERT(DATE, '1995-06-30', 23), 'michaelbrown@gmail.com', 'SecurePwd456', 7, 3);

INSERT INTO UserAccount (UserID, Name, Surname, DateOfBirth, Email, Password, LanguageID, SubscriptionID)
VALUES (6, 'Sophia', 'Lee', CONVERT(DATE, '2007-09-12', 23), 'sophialee@gmail.com', 'Pa$$word789', 10, 2);

INSERT INTO UserAccount (UserID, Name, Surname, DateOfBirth, Email, Password, LanguageID, SubscriptionID)
VALUES (7, 'David', 'Garcia', CONVERT(DATE, '2011-02-25', 23), 'davidgarcia@gmail.com', 'Secret123', 2, 1);

INSERT INTO UserAccount (UserID, Name, Surname, DateOfBirth, Email, Password, LanguageID, SubscriptionID)
VALUES (8, 'Olivia', 'Martinez', CONVERT(DATE, '2002-07-08', 23), 'oliviamartinez@gmail.com', 'P@ssw0rd456', 4, 3);

INSERT INTO UserAccount (UserID, Name, Surname, DateOfBirth, Email, Password, LanguageID, SubscriptionID)
VALUES (9, 'William', 'Taylor', CONVERT(DATE, '1989-12-20', 23), 'williamtaylor@gmail.com', 'MyP@ss123', 6, 2);

INSERT INTO UserAccount (UserID, Name, Surname, DateOfBirth, Email, Password, LanguageID, SubscriptionID)
VALUES (10, 'Emma', 'Anderson', CONVERT(DATE, '1999-03-10', 23), 'emmaanderson@gmail.com', 'SecurePwd789', 8, 1);
...
INSERT INTO Film (FilmID, LengthMin, ReleaseDate) VALUES (4, 97, CONVERT(DATE, '2004-08-06', 23));
INSERT INTO Film (FilmID, LengthMin, ReleaseDate) VALUES (5, 101, CONVERT(DATE, '1996-07-05', 23));
INSERT INTO Film (FilmID, LengthMin, ReleaseDate) VALUES (6, 113, CONVERT(DATE, '2022-05-13', 23));
INSERT INTO Film (FilmID, LengthMin, ReleaseDate) VALUES (7, 97, CONVERT(DATE, '1995-12-08', 23));

-- Episode (Ratched, 1 Season)
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (1, 1, 'Pilot', 1, 1, 56, CONVERT(DATE, '2020-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (2, 1, 'Ice Pick', 1, 2, 50, CONVERT(DATE, '2020-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (3, 1, 'Angel of Mercy', 1, 3, 50, CONVERT(DATE, '2020-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (4, 1, 'Angel of Mercy: Part Two', 1, 4, 53, CONVERT(DATE, '2020-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (5, 1, 'The Dance', 1, 5, 62, CONVERT(DATE, '2020-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (6, 1, 'Got No Strings', 1, 6, 45, CONVERT(DATE, '2020-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (7, 1, 'The Bucket List', 1, 7, 58, CONVERT(DATE, '2020-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (8, 1, 'Mildred and Edmund', 1, 8, 59, CONVERT(DATE, '2020-09-18', 23));

-- Episode (Sex Education, 1 Season)
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (9, 2, 'Episode 1', 1, 1, 52, CONVERT(DATE, '2019-01-12', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (10, 2, 'Episode 2', 1, 2, 50, CONVERT(DATE, '2019-01-12', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (11, 2, 'Episode 3', 1, 3, 51, CONVERT(DATE, '2019-01-12', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (12, 2, 'Episode 4', 1, 4, 47, CONVERT(DATE, '2019-01-12', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (13, 2, 'Episode 5', 1, 5, 47, CONVERT(DATE, '2019-01-12', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (14, 2, 'Episode 6', 1, 6, 50, CONVERT(DATE, '2019-01-12', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (15, 2, 'Episode 7', 1, 7, 52, CONVERT(DATE, '2019-01-12', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (16, 2, 'Episode 8', 1, 8, 53, CONVERT(DATE, '2019-01-12', 23));

-- Ratched Series
-- 2 Season
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (17, 2, 'Episode 1', 2, 1, 51, CONVERT(DATE, '2020-01-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (18, 2, 'Episode 2', 2, 2, 51, CONVERT(DATE, '2020-01-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (19, 2, 'Episode 3', 2, 3, 49, CONVERT(DATE, '2020-01-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (20, 2, 'Episode 4', 2, 4, 51, CONVERT(DATE, '2020-01-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (21, 2, 'Episode 5', 2, 5, 53, CONVERT(DATE, '2020-01-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (22, 2, 'Episode 6', 2, 6, 55, CONVERT(DATE, '2020-01-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (23, 2, 'Episode 7', 2, 7, 50, CONVERT(DATE, '2020-01-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (24, 2, 'Episode 8', 2, 8, 59, CONVERT(DATE, '2020-01-18', 23));

-- 3 Season
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (25, 2, 'Episode 1', 3, 1, 54, CONVERT(DATE, '2021-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (26, 2, 'Episode 2', 3, 2, 61, CONVERT(DATE, '2021-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (27, 2, 'Episode 3', 3, 3, 53, CONVERT(DATE, '2021-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (28, 2, 'Episode 4', 3, 4, 54, CONVERT(DATE, '2021-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (29, 2, 'Episode 5', 3, 5, 54, CONVERT(DATE, '2021-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (30, 2, 'Episode 6', 3, 6, 59, CONVERT(DATE, '2021-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (31, 2, 'Episode 7', 3, 7, 58, CONVERT(DATE, '2021-09-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (32, 2, 'Episode 8', 3, 8, 60, CONVERT(DATE, '2021-09-18', 23));

-- 4 Season
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (33, 2, 'Episode 1', 4, 1, 55, CONVERT(DATE, '2023-09-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (34, 2, 'Episode 2', 4, 2, 51, CONVERT(DATE, '2023-09-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (35, 2, 'Episode 3', 4, 3, 55, CONVERT(DATE, '2023-09-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (36, 2, 'Episode 4', 4, 4, 56, CONVERT(DATE, '2023-09-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (37, 2, 'Episode 5', 4, 5, 55, CONVERT(DATE, '2023-09-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (38, 2, 'Episode 6', 4, 6, 66, CONVERT(DATE, '2023-09-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (39, 2, 'Episode 7', 4, 7, 60, CONVERT(DATE, '2023-09-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (40, 2, 'Episode 8', 4, 8, 85, CONVERT(DATE, '2023-09-22', 23));

-- Snowpiercer Series
-- 1 Season
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (41, 3, 'First, the Weather Chan', 1, 1, 52, CONVERT(DATE, '2020-05-18', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (42, 3, 'Prepare to Brace', 1, 2, 46, CONVERT(DATE, '2020-05-25', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (43, 3, 'Access Is Power', 1, 3, 46, CONVERT(DATE, '2020-06-01', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (44, 3, 'Without Their Maker', 1, 4, 46, CONVERT(DATE, '2020-06-08', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (45, 3, 'Justice Never Boarded', 1, 5, 47, CONVERT(DATE, '2020-06-15', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (46, 3, 'Trouble Comes Sideways', 1, 6, 46, CONVERT(DATE, '2020-06-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (47, 3, 'The Universe Is Indifferent', 1, 7, 47, CONVERT(DATE, '2020-06-29', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (48, 3, 'These Are His Revolutions', 1, 8, 48, CONVERT(DATE, '2020-07-06', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (49, 3, 'EThe Train Demanded Blood', 1, 9, 44, CONVERT(DATE, '2020-07-13', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (50, 3, '994 Cars Long', 1, 10, 45, CONVERT(DATE, '2020-07-13', 23));

-- 2 Season
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (51, 3, 'The Time of Two Engines', 2, 1, 47, CONVERT(DATE, '2021-01-21', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (52, 3, 'Smolder to Life', 2, 2, 48, CONVERT(DATE, '2021-02-02', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (53, 3, 'A Great Odyssey', 2, 3, 45, CONVERT(DATE, '2021-02-09', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (54, 3, 'A Single Trade', 2, 4, 47, CONVERT(DATE, '2021-02-16', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (55, 3, 'Keep Hope Alive', 2, 5, 47, CONVERT(DATE, '2021-02-23', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (56, 3, 'Many Miles from Snowpiercer', 2, 6, 46, CONVERT(DATE, '2021-03-02', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (57, 3, 'Our Answer for Everything', 2, 7, 47, CONVERT(DATE, '2021-03-09', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (58, 3, 'The Eternal Engineer', 2, 8, 48, CONVERT(DATE, '2021-03-16', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (59, 3, 'The Show Must Go On', 2, 9, 47, CONVERT(DATE, '2021-03-30', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (60, 3, 'Into the White', 2, 10, 47, CONVERT(DATE, '2021-03-30', 23));

-- 3 Season
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (61, 3, 'The Tortoise and the Hare', 3, 1, 47, CONVERT(DATE, '2022-01-25', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (62, 3, 'The Last to Go', 3, 2, 47, CONVERT(DATE, '2022-02-01', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (63, 3, 'The First Blow', 3, 3, 46, CONVERT(DATE, '2022-02-08', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (64, 3, 'Bound by One Track', 3, 4, 47, CONVERT(DATE, '2022-02-15', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (65, 3, 'A New Life', 3, 5, 44, CONVERT(DATE, '2022-02-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (66, 3, 'Born to Bleed', 3, 6, 47, CONVERT(DATE, '2022-03-01', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (67, 3, 'Ouroboros', 3, 7, 45, CONVERT(DATE, '2022-03-08', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (68, 3, 'Setting Itself Right', 3, 8, 47, CONVERT(DATE, '2022-03-15', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (69, 3, 'A Beacon for Us All', 3, 9, 47, CONVERT(DATE, '2022-03-22', 23));
INSERT INTO Episode (EpisodeID, SeriesID, Name, Season, EpisodeInSeason, LengthMin, ReleaseDate) VALUES (70, 3, 'The Original Sinners', 3, 10, 49, CONVERT(DATE, '2022-03-29', 23));
